...
def create_database(yelp_list=[], *args):
    """
        ...
        yelp_list: takes in the main list created by aggregrate_yelp,
                   defaults to empty
    ...
    #Create and update the database only if yelp_list is not empty
...
#   price_range = ['2', '3', '4']
    ...
    #Create a record for each zip code and price range combination
    for zip_code in zip_codes:
        for price in price_range:
            ...
            #For each item in the yelp list, update the zip code
            for listing in yelp_list:
